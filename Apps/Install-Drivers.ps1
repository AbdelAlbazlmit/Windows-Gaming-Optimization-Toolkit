...
switch ($choice) {
    ...
    "3" { choco install intel-chipset -y --no-progress; Write-Host "[✓] Intel Chipset installed" }
    "4" { choco install realtek-audio -y --no-progress; Write-Host "[✓] Realtek Audio installed" }
}
