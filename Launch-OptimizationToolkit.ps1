...
function Show-MainMenu {
    ...
    Write-Host "`n[!] WARNING: Aggressive system modifications" -ForegroundColor Yellow
    Write-Host "[!] Always create restore points before running`n" -ForegroundColor Yellow
...
do {
    ...
    switch ($choice) {
        ...
        default { Write-Host "[ERROR] Invalid option" -ForegroundColor Red; Read-Host "Press Enter" }
    }
} while ($true)